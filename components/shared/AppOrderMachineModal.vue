            ...
            <div>
                ...
                <div class="grid laptop:grid-cols-[210px_auto_340px_auto_210px] items-center justify-between mb-6">
                    <div
                        ...
                        <h5 class="text-gray-700 font-semibold">€600</h5>
                        <p class="text-gray-700">Per Hectares</p>
                    </div>
                    <div class="grid place-items-center text-gray-900 font-semibold text-h4">X</div>
                    <div
                        class="flex flex-col items-center justify-center py-6 px-4 rounded-xl border border-wispy-white-200 bg-wispy-white-50">
                        <h5 class="text-gray-700 font-semibold">€600</h5>
                        <p class="text-gray-700">Per Hectares</p>
                    </div>
                    ...
                    <div
                        ...
                        <h5 class="text-white font-semibold">€600</h5>
